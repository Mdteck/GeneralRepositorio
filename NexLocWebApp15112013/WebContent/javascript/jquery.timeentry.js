...
function TimeEntry() {
	...
	this.regional[''] = { // Default regional settings
		...
		spinnerTexts: ['Actual', 'Hora', 'Minutos', 'Incrementar', 'Decrementar']
	...
	this._defaults = {
		...
		spinnerImage: '../stylesheets/images/spinnerDefault.png', // The URL of the images to use for the time spinner
